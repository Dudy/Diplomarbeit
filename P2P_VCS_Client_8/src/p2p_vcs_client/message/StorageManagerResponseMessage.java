 ...
 * @author podolak
 */
public class StorageManagerResponseMessage extends CommandMessage {

    private StorageManager storageManager;

    public StorageManagerResponseMessage(NodeHandle sender, Id vcsId, StorageManager storageManager) {
        super(sender, vcsId, MessageType.STORAGE_MANAGER_REQUEST);
        this.storageManager = storageManager;
    }

    // <editor-fold defaultstate="collapsed" desc=" serialization ">
    public StorageManagerResponseMessage(NodeHandle sender, InputBuffer buf, Endpoint endpoint) throws IOException {
